...
public class InputEmployeeForm extends javax.swing.JFrame {
    ...
    public InputEmployeeForm(String eCode, String eName, String eBd, String eAddress, String eEmail, String ePhone, String eSd, Long eSalary , int row) {
        initComponents();
        ...
        salaryField.setText(Long.toString(eSalary));
        this.row = row;
        isUpdate = true;
    }
